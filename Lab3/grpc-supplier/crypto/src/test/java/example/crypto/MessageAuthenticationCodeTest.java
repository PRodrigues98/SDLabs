...
/**
 * Test suite to show how the Java Security API can be used for message
...
public class MessageAuthenticationCodeTest {
	 ...
	 * separately (for illustration purposes). It is better to use the Mac
	 * object.
	 */
	@Test
	public void testSignatureStepByStep() throws Exception {
		...
		System.out.println(DIGEST_ALGO);
