...
public class CryptoDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		out.println(
				"The Java Cryptography Architecture (JCA) includes a large set of ");
		...
		out.println(
				"A message digest is a cryptographic one-way hashing function computed from an input.");
		out.println(
				"Digests can be used to detect changes to a message and to build integrity protection.");
		out.println();
		...
		out.println("but it can be combined with a cipher to produce a signature.");
		out.println();

		out.println("Press enter to conclude");
		scanner.nextLine();
		
		out.println("This is the end of the demonstration.");
		out.println();
		out.println("You can find more code snippets in the tests and examples.");
		out.println("Look into the src/main/java and src/test/java folder.");
		out.println();

		out.println("You can find the JCA documentation here:");
		out.println("https://docs.oracle.com/javase/8/docs/technotes/guides/security/crypto/CryptoSpec.html#Introduction");
		out.println();
